                    ...
                    <div className="px-6 pt-6 pb-2">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-sm font-semibold text-slate-900 dark:text-white">
                                {requiresOtp ? '2-Step Verification' : 'Sign in'}
                            </span>
                    ...
                    <div className="p-6 flex flex-col gap-5">
                        {!requiresOtp ? (
                            ...
                            <form className="flex flex-col gap-5" onSubmit={handleOtpSubmit}>
                                ...
                                <div className="bg-primary/10 border border-primary/30 p-4 rounded-lg flex gap-3 items-start">
                                    <span className="material-symbols-outlined text-primary mt-0.5 text-[20px]">smartphone</span>
                                    <div>
                                        <p className="text-sm text-slate-700 dark:text-slate-300 font-medium">
                                            Open Google Authenticator
                                        </p>
                                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                                            Enter the 6-digit code generated by the app for your account.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <button
                                    className="w-full h-11 bg-primary hover:bg-primary/90 text-white font-semibold rounded-lg shadow-sm shadow-primary/30 transition-all flex items-center justify-center gap-2 mt-2"
                                    type="submit"
